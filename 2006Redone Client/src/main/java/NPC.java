...
public final class NPC extends Entity {
	...
	private Model method450() {
		if (super.anim >= 0 && super.anInt1529 == 0) {
			int k = Animation.anims[super.anim].primary[super.anInt1527];
			int i1 = -1;
			if (super.anInt1517 >= 0 && super.anInt1517 != super.anInt1511) {
				i1 = Animation.anims[super.anInt1517].primary[super.anInt1518];
			}
			return desc.method164(i1, k, Animation.anims[super.anim].vertices);
		}
		int l = -1;
	...
	public Model getRotatedModel() {
		...
		if (super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if (model_1 != null) {
				int j = spotAnim.animationSequence.primary[super.anInt1521];
