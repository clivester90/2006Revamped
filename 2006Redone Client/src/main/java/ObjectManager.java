...
final class ObjectManager {
	...
	public void createRegionScene(CollisionMap[] collisionMaps, WorldController worldController) {
		for (int j = 0; j < 4; j++) {
			for (int k = 0; k < 104; k++) {
					...
					for (int k17 = -5; k17 < regionSizeY + 5; k17++) {
						...
						if (k17 >= 1 && k17 < regionSizeY - 1 && (!lowMem || (tileFlags[0][x][k17] & 2) != 0 || (tileFlags[l][x][k17] & 0x10) == 0 && getVisiblePlane(k17, l, x) == buildPlane)) {
							...
							if (l18 > 0 || i19 > 0) {
								...
								int i22 = 0;
								if (j21 != -1) {
									i22 = Texture.anIntArray1482[adjustHSLLightness(k21, 96)];
								}
								if (i19 == 0) {
									worldController.addTile(l, x, k17, 0, 0, -1, j19, k19, l19, i20, adjustHSLLightness(j21, j20), adjustHSLLightness(j21, k20), adjustHSLLightness(j21, l20), adjustHSLLightness(j21, i21), 0, 0, 0, 0, i22, 0);
								} else {
									...
									if (i23 >= 0) {
										...
										k23 = Texture.anIntArray1482[getRGB(floorDefinition_2.hsl16, 96)];
										j23 = -2;
										i23 = -1;
									} else {
									...
									worldController.addTile(l, x, k17, k22, byte4, i23, j19, k19, l19, i20, adjustHSLLightness(j21, j20), adjustHSLLightness(j21, k20), adjustHSLLightness(j21, l20), adjustHSLLightness(j21, i21), getRGB(j23, j20), getRGB(j23, k20), getRGB(j23, l20), getRGB(j23, i21), i22, k23);
								}
							}
						}
					}
					...
					for (int i4 = 0; i4 <= regionSizeX; i4++) {
						if ((cullingMap[i3][i4][k3] & i2) != 0) {
							...
							if (l10 >= 8) {
								...
								WorldController.createNewSceneCluster(l2, i4 * 128, l15, i4 * 128, l5 * 128 + 128, k14, k4 * 128, 1);
						...
						if ((cullingMap[i3][i4][k3] & j2) != 0) {
							...
							if (k11 >= 8) {
								...
								WorldController.createNewSceneCluster(l2, l4 * 128, i16, i6 * 128 + 128, k3 * 128, l14, k3 * 128, 2);
						...
						if ((cullingMap[i3][i4][k3] & k2) != 0) {
							...
							if ((j6 - i5 + 1) * (i9 - k7 + 1) >= 4) {
								...
								WorldController.createNewSceneCluster(l2, i5 * 128, j12, j6 * 128 + 128, i9 * 128 + 128, j12, k7 * 128, 4);
	...
	public static void evaluateObjects(Stream stream, OnDemandFetcher demandFetcher) {
		label0 : {
			int i = -1;
			do {
				...
				class46.method574(demandFetcher);
				do {
	...
	private void addObject(int i, WorldController worldController, CollisionMap class11, int j, int k, int l, int i1, int j1) {
		...
		if (j == 22) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj = new SceneNode_Sub5(i1, j1, 22, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 10 || j == 11) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj1 = new SceneNode_Sub5(i1, j1, 10, l1, i2, k1, j2, class46.animationID, true);
			}
			if (obj1 != null) {
				int i5 = 0;
				if (j == 11) {
		...
		if (j >= 12) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj2 = new SceneNode_Sub5(i1, j1, j, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 0) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj3 = new SceneNode_Sub5(i1, j1, 0, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 1) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj4 = new SceneNode_Sub5(i1, j1, 1, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 2) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj11 = new SceneNode_Sub5(i1, 4 + j1, 2, l1, i2, k1, j2, class46.animationID, true);
				obj12 = new SceneNode_Sub5(i1, i3, 2, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 3) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj5 = new SceneNode_Sub5(i1, j1, 3, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 9) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj6 = new SceneNode_Sub5(i1, j1, j, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 4) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj7 = new SceneNode_Sub5(i1, 0, 4, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 5) {
			...
			if (k4 > 0) {
				i4 = ObjectDef.forID(k4 >> 14 & 0x7fff).wallWidth;
			}
			Object obj13;
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				obj13 = class46.method578(4, 0, k1, l1, i2, j2, -1);
			} else {
				obj13 = new SceneNode_Sub5(i1, 0, 4, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 6) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj8 = new SceneNode_Sub5(i1, 0, 4, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 7) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj9 = new SceneNode_Sub5(i1, 0, 4, l1, i2, k1, j2, class46.animationID, true);
			}
		...
		if (j == 8) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj10 = new SceneNode_Sub5(i1, 0, 4, l1, i2, k1, j2, class46.animationID, true);
			}
	...
	public void loadObjects(CollisionMap[] aclass11, WorldController worldController, int i, int j, int k, int l, byte[] abyte0, int i1, int j1, int k1) {
		label0 : {
			Stream stream = new Stream(abyte0);
			int l1 = -1;
			do {
	...
	public static void addObject(WorldController worldController, int i, int j, int k, int l, CollisionMap class11, int[][][] ai, int i1, int j1, int k1) {
		...
		if (k == 22) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj = new SceneNode_Sub5(j1, i, 22, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 10 || k == 11) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj1 = new SceneNode_Sub5(j1, i, 10, i2, j2, l1, k2, class46.animationID, true);
			}
			if (obj1 != null) {
				int j5 = 0;
				if (k == 11) {
		...
		if (k >= 12) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj2 = new SceneNode_Sub5(j1, i, k, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 0) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj3 = new SceneNode_Sub5(j1, i, 0, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 1) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj4 = new SceneNode_Sub5(j1, i, 1, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 2) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj11 = new SceneNode_Sub5(j1, 4 + i, 2, i2, j2, l1, k2, class46.animationID, true);
				obj12 = new SceneNode_Sub5(j1, j3, 2, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 3) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj5 = new SceneNode_Sub5(j1, i, 3, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 9) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj6 = new SceneNode_Sub5(j1, i, k, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 4) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj7 = new SceneNode_Sub5(j1, 0, 4, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 5) {
			...
			if (l4 > 0) {
				j4 = ObjectDef.forID(l4 >> 14 & 0x7fff).wallWidth;
			}
			Object obj13;
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				obj13 = class46.method578(4, 0, l1, i2, j2, k2, -1);
			} else {
				obj13 = new SceneNode_Sub5(j1, 0, 4, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 6) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj8 = new SceneNode_Sub5(j1, 0, 4, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 7) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj9 = new SceneNode_Sub5(j1, 0, 4, i2, j2, l1, k2, class46.animationID, true);
			}
		...
		if (k == 8) {
			...
			if (class46.animationID == -1 && class46.childrenIDs == null) {
				...
				obj10 = new SceneNode_Sub5(j1, 0, 4, i2, j2, l1, k2, class46.animationID, true);
			}
	...
	public void loadObjects(int i, CollisionMap[] aclass11, int j, WorldController worldController, byte[] abyte0) {
		label0 : {
			Stream stream = new Stream(abyte0);
			int l = -1;
			do {
