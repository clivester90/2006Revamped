...
final class SceneSpotAnim extends SceneNode {
    ...
    public Model getRotatedModel() {
        ...
        int   j       = aSpotAnim_1568.animationSequence.primary[anInt1569];
    ...
    public void method454(int i) {
        for (anInt1570 += i; anInt1570 > aSpotAnim_1568.animationSequence.getDuration(anInt1569); ) {
            anInt1570 -= aSpotAnim_1568.animationSequence.getDuration(anInt1569) + 1;
            anInt1569++;
            if (anInt1569 >= aSpotAnim_1568.animationSequence.length && (anInt1569 < 0 || anInt1569 >= aSpotAnim_1568.animationSequence.length)) {
                anInt1569 = 0;
                isFinished = true;
            }
        }
