...
public final class Main {
	...
	If you want to run the client locally, the easiest way to do that is run the class "com.Client.java" instead!

	If you REALLY want to use this class, add two random program arguments.
	But seriously, com.Client.java is just a copy-paste of this class and does it locally. Use that instead!
