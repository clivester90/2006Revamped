package com;/* com.Class56_Sub1_Sub2 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

import com.client.sound.MidiPlayer;

final class Class56_Sub1_Sub2 extends Class56 implements Runnable
{
    ...
    void sendMessage(int i, int i_4_, int i_5_, long l) {
    	method845(i, (int) l, i_4_, i_5_);
    }
    
    public synchronized void method827(int i, byte[] is, int i_6_,
									   boolean bool) {
		...
		MidiPlayer.setVolume(i_6_, i, (long) anInt1855);
		...
		if (bool_7_) {
			...
			MidiPlayer.setTick((long) anInt1855);
    ...
    public synchronized void method831(int i) {
		MidiPlayer.method840(i, (long) anInt1855);
		aRunnable_Impl1_1852.method10(anIntArray1858, anInt1856);
		anInt1856 = 0;
    }
    ...
    private void method847(int i, long l, int i_17_) {
    	...
    	if (i_18_ != 1) {
    		if ((i_18_ & 0x80) != 0) {
			    ...
			    if (!MidiPlayer.check(i_20_, i_22_, i_21_, i_19_))
    ...
    public synchronized void method830(int i, int i_23_) {
		MidiPlayer.setVolume(i_23_, i, anInt1855);
    }
}
